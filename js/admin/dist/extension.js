...
System.register('HDUAAA/auth/cas/components/CASSettingsModal', ['flarum/components/SettingsModal'], function (_export, _context) {
  "use strict";
        ...
        babelHelpers.createClass(CASSettingsModal, [{
          ...
          value: function form() {
            return [m(
              ...
              m('input', { className: 'FormControl', bidi: this.setting('HDUAAA-auth-cas.client_id') })
            ), m(
              'div',
              { className: 'Form-group' },
              m(
              ...
              m('input', { className: 'FormControl', bidi: this.setting('HDUAAA-auth-cas.client_secret') })
            )];
          }
        }]);
...
System.register('HDUAAA/auth/cas/main', ['flarum/app', 'HDUAAA/auth/cas/components/CASSettingsModal'], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      app.initializers.add('HDUAAA-auth-cas', function () {
        app.extensionSettings['HDUAAA-auth-cas'] = function () {
